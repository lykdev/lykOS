...
{
  return (resource_table_t){.resources = NULL, .length = 0, .lock = SLOCK_INIT};
}
...
resource_t *resource_create_at(resource_table_t *table, int id,
                               vfs_node_t *node, size_t offset, u8 flags)
{
