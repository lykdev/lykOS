...
#define __MODULE_INFO(tag, info) \
    static const char __module_##tag[] = info
...
#define MODULE_INSTALL(fn) void *__module_install = fn;
#define MODULE_DESTROY(fn) void *__module_destroy = fn;
#define MODULE_PROBE(fn)   void *__module_probe   = fn;